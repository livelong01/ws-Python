...
class Banco:
    def __init__(
        ...
        self.agencias = agencias or []  # Se for None, se torna uma lista vazia
...
if __name__ == '__main__':
    ...
    c1 = pessoas.Cliente('Luiz', 29)
    cc1 = contas.ContaCorrente(111, 222, 0, 0)
    c1.conta = cc1
    c2 = pessoas.Cliente('Jonathan', 33)
    cp1 = contas.ContaPoupanca(222, 333, 10)
    c2.conta = cp1
    banco = Banco()
