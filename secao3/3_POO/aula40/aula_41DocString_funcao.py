...
class Foo:
    ...
    def multiplica(self,
        x: int | float,
        y: int | float,
        z: int | float | None = None # z é opcional. começa com None.
    ) -> int | float:
    ...
    def bar(self) -> int:
        ...
        :raises NotImplementError: Se o metodo n for definido.
        :raises ValueError: Se o metodo n for definido.
        """
        raise NotImplementedError('TESTE') #isso n aparece
